...
#define __FREE_VMM_START (INIT_PET_TABLES_START + INIT_TABLES_NUM * PAGE_SIZE)
#define FREE_VMM_START ((__FREE_VMM_START + (PAGE_SIZE - 1)) / PAGE_SIZE * PAEG_SIZE) // ALIGN PAGE_SIZE

//total num of free page
#define FREE_PAGE_TOTAL ((KERNEL_VMM_START + PHY_MM_SIZE) / PAGE_SIZE)
